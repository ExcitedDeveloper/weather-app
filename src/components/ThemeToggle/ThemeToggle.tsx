  ...
  return (
    ...
    >
      <div className="relative h-6 w-6">
        {theme === 'light' ? (
          <svg
            className="h-6 w-6 text-gray-700 transition-all duration-300 group-hover:scale-110 dark:text-white"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          ...
          <svg
            className="h-6 w-6 text-yellow-400 transition-all duration-300 group-hover:scale-110 group-hover:text-yellow-300"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
